...
public class AddDrivers extends JFrame implements ActionListener{
    ...
    public AddDrivers() {
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Icons/driver1.jpg"));
        ...
        l1.setFont(new Font("Thoma", Font.BOLD, 14));
        ...
        l2.setFont(new Font("Thoma", Font.BOLD, 14));
        ...
        l3.setFont(new Font("Thoma", Font.BOLD, 14));
        ...
        l4.setFont(new Font("Thoma", Font.BOLD, 14));
        ...
        l5.setFont(new Font("Thoma", Font.BOLD, 14));
        ...
        l6.setFont(new Font("Thoma", Font.BOLD, 14));
        ...
        l7.setFont(new Font("Thoma", Font.BOLD, 14));
